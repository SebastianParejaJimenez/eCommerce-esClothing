        ...
        <div class="mx-auto max-w-4xl px-3 py-0.5 sm:px-6 sm:py-0.5 lg:max-w-7xl lg:px-5">
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Ha ocurrido un
                                        Error</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Actualmente, hay un error entre la conexión de la pasarela de pagos. Le recomendamos que vuelva a intentarlo más tarde. Lamentamos las molestias y agradecemos su comprensión.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            @if (session('no_incrementado'))
                <script>
                    ...
                    Toast.fire({
                        icon: "error",
                        title: "No se pueden añadir mas Cantidades a este Producto."
                    });
                </script>
            @endif
