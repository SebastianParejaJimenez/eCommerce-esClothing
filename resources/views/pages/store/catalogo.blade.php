                    ...
                    <div class="md:flex md:items-center mt-5">
                        ...
                        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                            ...
                            <form class="flex items-center mt-6" action="{{route('agregaritem')}}" method="POST">
                                ...
                                @csrf
                                <button class="flex items-center justify-center px-2 py-2 mt-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-800 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
                            <a href="" class="group-hover:opacity-100">
                                <img class="object-cover w-full rounded-md h-72 xl:h-80" src="{{ url('productos_subidos') }}/{{ $producto->imagen }}" alt="T-Shirt">
                            </a>
                            <h4 class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-200">{{$producto->nombre}}</h4>
                            <p class="text-blue-500">${{ number_format($producto->precio, 0, ',', '.') }}</p>
