    ...
    <div class="relative overflow-x-auto px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
        ...
        @if (!$ordenes->count())
             <div class="text-center mt-12 bg-white py-20 rounded-md dark:bg-slate-500">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="mx-auto h-12 w-12 text-gray-400 dark:text-gray-200" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
