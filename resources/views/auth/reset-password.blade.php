        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10 grid content-center">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900 mb-1">Ingresa tu nueva contraseña</h1>
                    <p>Ingresa la nueva contraseña junto al correo al cual quieres hacer el cambio</p>
                </div>
