<x-authentication-layout>
    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10 grid content-center">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900">Reiniciar Contraseña</h1>
                    <p>Si olvidaste o perdiste tu contraseña puedes cambiarla ingresando tu correo para recibir el correo con los pasos</p>
                </div>
