                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('productos.store') }}"
                        ...
                        <div class="md:col-span-5 dark:text-white mb-3">
                            ...
                            <input type="number" id="precio" name="precio" min="1"
                                placeholder="Ingrese el Precio que tendra este Producto" :value="old('precio')"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                        </div>

                        <div class="md:col-span-3 dark:text-white mb-3">
                            <label for="cantidad">Cantidades Disponibles</label>
                            <input type="number" id="cantidad" name="cantidad" min="1"
                                placeholder="Ingrese las Cantidades que tenga del Producto" :value="old('cantidad')"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2 dark:text-white mb-3">
                            ...
                            <select x-model="selectedCategory" type="text" id="categorias" name="categoria" :value="old('categoria')"
                        ...
                        <div class="md:col-span-5 dark:text-white mb-3">
                            <label
                                ...
                                Imagen
                                del Producto</label>
                            <input id="imagen" :value="old('imagen')" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" type="file" name="imagen" accept="image/png, image/jpeg, image/jpg" >
...
<script>
        function validateFm() {
            ...
            $(".formulario-validacion").validate({
                ...
                ignore: ":hidden", // Ignorar elementos ocultos
            });
        }
