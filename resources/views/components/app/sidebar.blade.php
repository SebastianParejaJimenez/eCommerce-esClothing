                    ...
                    <nav x-bind:class="! open ? 'w-0' : 'w-[280px]'" class="fixed top-0 transition-all lg:mt-0 z-0  left-0 dark:bg-[#182235] bottom-0 flex flex-col w-[280px] lg:border-none border-r border-gray-200 dark:border-gray-800 bg-gray-50 overflow-hidden "
                        ...
                        <div class="pb-6 mt-4 overflow-x-hidden overflow-y-auto">
                            <ul class="mb-8 text-sm">
                                ...
                                <li>
                                    <a href="{{route('redes_sociales.index')}}"
                                        class="flex items-center px-6 py-4 text-gray-700 @if(in_array(Request::segment(1), ['redes_sociales'])){{'dark:bg-slate-800 bg-gray-200 '}} @endif dark:text-gray-400 group dark:hover:bg-gray-700 hover:bg-gray-100">
                                        <span class="inline-block mr-3 text-gray-700 dark:text-gray-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
