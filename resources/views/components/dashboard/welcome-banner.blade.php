...
<div class="relative bg-white shadow-lg rounded-sm border border-slate-200 dark:border-slate-700  dark:bg-slate-800 p-4 sm:p-6 overflow-hidden mb-8">
            ...
            <div class="ml-[18px] flex h-[90px] w-auto flex-row items-center">
                <div class="rounded-full bg-lightPrimary p-3 dark:bg-navy-700">
                    <span class="flex items-center text-brand-500 dark:text-white">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="h-7 w-7"
